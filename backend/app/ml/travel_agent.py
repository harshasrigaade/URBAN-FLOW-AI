...
class TravelAgentAssistant:
    ...
    def process_message(self, message: str, current_lat: float = None, current_lng: float = None) -> ChatResponse:
        ...
        generic_replies = [
            ...
            "Remember, traveling via public transit (Metro/Train) or active travel (Bicycle) awards you Green travel points! How can I assist you with your journey today?"
        ]
