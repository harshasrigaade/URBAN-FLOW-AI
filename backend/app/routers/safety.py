...
def trigger_sos(
    ...
    for contact in contacts_list:
        print(f"SMS SENT TO {contact} -> '{current_user.name} triggered SOS! Live GPS: https://maps.google.com/?q={sos_in.latitude},{sos_in.longitude}'")
    ...
    return SOSResponse(
        ...
        notified_contacts=[c.split(":")[0] for c in contacts_list]
    )
